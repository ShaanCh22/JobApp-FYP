class OnBoardContent{
  ...
  String description;
  int color;
  OnBoardContent({required this.image,required this.title,required this.description,required this.color});
}
List<OnBoardContent> contents = [
  ...
  OnBoardContent(
      ...
      description: 'Our job include several industries, so you can find the best job for you.'
  ),
  OnBoardContent(
  ...
  OnBoardContent(
      ...
      description: 'We help you find your dream job based on your skillet, location, demand.'
  )
];